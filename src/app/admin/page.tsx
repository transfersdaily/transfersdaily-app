...
export default function AdminDashboard() {
  ...
  const kpis = stats ? [
    ...
    {
      title: "This Month",
      value: (stats.createdThisMonth || 0).toString(),
      change: stats.createdThisWeek ? `${stats.createdThisWeek} this week` : "",
  ...
  const quickActions = [
    ...
    { title: "Analytics", desc: "View site traffic", icon: BarChart3, color: "text-green-500", href: "/admin/analytics" },
    { title: "Contact Messages", desc: "View submissions", icon: MessageSquare, color: "text-purple-500", href: "/admin/messages" },
    { title: "Pipeline", desc: "Monitor scraping", icon: Activity, color: "text-blue-500", href: "/admin/pipeline" },
  ]
