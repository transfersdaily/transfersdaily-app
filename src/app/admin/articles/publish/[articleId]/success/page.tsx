    ...
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="bg-white border-b border-slate-200">
        <div className="max-w-4xl mx-auto px-6 py-8">
          <div className="text-center">
            ...
            <h1 className="heading text-3xl font-bold text-black mb-2">Article Published Successfully!</h1>
            <p className="text-slate-600">Your article is now live and visible to readers</p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-6 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <Card>
            <CardHeader>
              <CardTitle className="heading text-black font-bold">Published Article</CardTitle>
            </CardHeader>
            <CardContent className="space-y-4">
              <div>
                <h3 className="heading text-lg font-bold text-black mb-2">{article.title}</h3>
              ...
              <div className="space-y-2 text-sm">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="font-medium text-rose-600 break-all text-xs">
                    {getArticleUrl()}
                  </span>
                </div>
              </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="text-sm mb-3 break-words">
                      ...
                      <p className="text-blue-600 break-all text-xs">{getArticleUrl()}</p>
                    </div>
