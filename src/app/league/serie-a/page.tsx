...
export default function SerieAPage() {
  ...
  const loadTransfers = async () => {
    try {
      ...
      const response = await transfersApi.getByLeagueWithPagination('serie-a', itemsPerPage, offset)
      ...
      console.error('Error loading Serie A transfers:', error)
    } finally {
      setIsLoading(false)
    }
  }
  ...
  const clubs = ["Juventus", "AC Milan", "Inter Milan", "Napoli", "AS Roma", "Lazio", "Atalanta", "Fiorentina", "Bologna", "Torino", "Sassuolo", "Udinese", "Sampdoria", "Genoa", "Cagliari", "Spezia", "Venezia", "Empoli", "Salernitana", "Hellas Verona"]
            ...
            <section className="py-3 border-b bg-muted/30 -mx-4 px-4 mb-6">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3 flex-1">
                  ...
                  />
                  <h1 className="text-xl font-bold">Serie A Transfers</h1>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                {transfers.map((transfer) => (
                  <TransferCard
                    ...
                    primaryBadge={transfer.currentClub || 'Serie A'}
