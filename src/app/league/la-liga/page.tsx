...
export default function LaLigaPage() {
  ...
  const loadTransfers = async () => {
    try {
      ...
      const response = await transfersApi.getByLeagueWithPagination('la-liga', itemsPerPage, offset)
      ...
      console.error('Error loading La Liga transfers:', error)
    } finally {
      setIsLoading(false)
    }
  }
  ...
  const clubs = ["Real Madrid", "Barcelona", "Atletico Madrid", "Sevilla", "Valencia", "Real Sociedad", "Athletic Bilbao", "Villarreal", "Real Betis", "Getafe", "Osasuna", "Celta Vigo", "Espanyol", "Mallorca", "Cadiz", "Elche", "Almeria", "Girona", "Rayo Vallecano", "Valladolid"]
            ...
            <section className="py-3 border-b bg-muted/30 -mx-4 px-4 mb-6">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3 flex-1">
                  ...
                  />
                  <h1 className="text-xl font-bold">La Liga Transfers</h1>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                {transfers.map((transfer) => (
                  <TransferCard
                    ...
                    primaryBadge={transfer.currentClub || 'La Liga'}
