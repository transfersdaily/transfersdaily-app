...
export default function BundesligaPage() {
  ...
  const loadTransfers = async () => {
    try {
      ...
      const response = await transfersApi.getByLeagueWithPagination('bundesliga', itemsPerPage, offset)
      ...
      console.error('Error loading Bundesliga transfers:', error)
    } finally {
      setIsLoading(false)
    }
  }
  ...
  const clubs = ["Bayern Munich", "Borussia Dortmund", "RB Leipzig", "Bayer Leverkusen", "Eintracht Frankfurt", "Borussia Mönchengladbach", "VfB Stuttgart", "SC Freiburg", "Union Berlin", "FC Köln", "Werder Bremen", "FSV Mainz 05", "FC Augsburg", "VfL Bochum", "TSG Hoffenheim", "Hertha BSC", "VfL Wolfsburg", "Arminia Bielefeld", "Fortuna Düsseldorf", "FC Schalke 04"]
            ...
            <section className="py-3 border-b bg-muted/30 -mx-4 px-4 mb-6">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3 flex-1">
                  ...
                  />
                  <h1 className="text-xl font-bold">Bundesliga Transfers</h1>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                {transfers.map((transfer) => (
                  <TransferCard
                    ...
                    primaryBadge={transfer.currentClub || 'Bundesliga'}
