...
export default function PremierLeaguePage() {
  ...
  const loadTransfers = async () => {
    try {
      ...
      const response = await transfersApi.getByLeagueWithPagination('premier-league', itemsPerPage, offset)
      
      // Filter by club if selected (client-side for now)
      ...
      console.error('Error loading Premier League transfers:', error)
    } finally {
      setIsLoading(false)
    }
  }
  ...
  const clubs = ["Manchester United", "Arsenal", "Chelsea", "Liverpool", "Manchester City", "Tottenham", "Newcastle", "West Ham", "Brighton", "Aston Villa", "Crystal Palace", "Fulham", "Brentford", "Wolves", "Everton", "Nottingham Forest", "Sheffield United", "Burnley", "Luton Town", "Bournemouth"]
          ...
          <div className="lg:col-span-8">
            ...
            <section className="py-3 border-b bg-muted/30 -mx-4 px-4 mb-6">
              <div className="flex items-center justify-between">
                {/* Left side - Title with League Logo */}
                <div className="flex items-center gap-3 flex-1">
                  ...
                  />
                  <h1 className="text-xl font-bold">Premier League Transfers</h1>
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                {transfers.map((transfer) => (
                  <TransferCard
                    ...
                    primaryBadge={transfer.currentClub || 'Premier League'}
