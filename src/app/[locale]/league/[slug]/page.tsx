...
export async function generateMetadata({ 
  ...
  return {
    ...
    openGraph: {
      title: currentSeo.title,
      description: currentSeo.description,
      url: locale === 'en' ? `${SITE_URL}/league/${slug}` : `${SITE_URL}/${locale}/league/${slug}`,
    ...
    "breadcrumb": {
      ...
      "itemListElement": [
        ...
        },
        {
          ...
          "item": locale === 'en' ? `${SITE_URL}/leagues` : `${SITE_URL}/${locale}/leagues`
        },
        {
          "@type": "ListItem",
          "position": 3,
          "name": leagueName,
          "item": locale === 'en' ? `${SITE_URL}/league/${slug}` : `${SITE_URL}/${locale}/league/${slug}`
        }
      ]
    }
  }
  ...
  const itemListStructuredData = transfers.length > 0 ? {
    ...
    "itemListElement": transfers.slice(0, 10).map((transfer: any, index: number) => ({
      ...
      "item": {
        ...
        "url": `${SITE_URL}/${locale}/article/${transfer.slug}`,
