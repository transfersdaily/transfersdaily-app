        ...
        <Card>
          <CardContent className="p-8 prose prose-gray dark:prose-invert max-w-none">
            ...
            <section className="mb-8">
              ...
              <p>
                Welcome to Transfer Daily ("we," "us," "our," or "Transfer Daily"). These Terms of Service ("Terms") govern your use of our website located at transfersdaily.com (the "Service") operated by Transfer Daily.
              </p>
              <p>
            ...
            <section className="mb-8">
              ...
              <div className="bg-muted p-4 rounded-lg mt-4">
                ...
                <p>Email: legal@transfersdaily.com</p>
