        ...
        <Card>
          <CardContent className="p-8 prose prose-gray dark:prose-invert max-w-none">
            ...
            <section className="mb-8">
              ...
              <p>
                Welcome to Transfer Daily ("we," "our," or "us"). We are committed to protecting your privacy and ensuring the security of your personal information. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website transfersdaily.com and use our services.
              </p>
              <p>
            ...
            <section className="mb-8">
              ...
              <div className="bg-muted p-4 rounded-lg mt-4">
                ...
                <p>Email: privacy@transfersdaily.com</p>
                <p>Website: <a href={`${SITE_URL}/contact`} className="text-primary hover:underline">transfersdaily.com/contact</a></p>
