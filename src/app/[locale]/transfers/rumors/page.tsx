...
async function getTransferRumorsData(language = 'en', page = 1, league = 'all') {
  try {
    ...
    const params = new URLSearchParams({ limit: '15', page: page.toString(), status: 'published', language: language, sortBy: 'published_at', sortOrder: 'desc', transfer_status: 'rumor' })
    if (league !== 'all') {
